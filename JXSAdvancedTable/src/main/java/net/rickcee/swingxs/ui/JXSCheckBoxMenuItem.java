 ...
 * 
 */
public class JXSCheckBoxMenuItem extends JCheckBoxMenuItem {

	private static final long serialVersionUID = -5627839986883872210L;
	 ...
	 * @param txt
	 */
	public JXSCheckBoxMenuItem(String txt) {
		super(txt);
		setUI(new JXSCheckBoxMenuItemUI());
	}
